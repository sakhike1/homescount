...
test.describe('Buyer and seller journeys', () => {
  test('buy page shows journey steps', async ({ page }) => {
    ...
    await expect(page.getByText(/why buy with homescount/i)).toBeVisible()
  ...
  test('rent page shows journey steps', async ({ page }) => {
    ...
    await acceptCookies(page)
    await expect(page.getByText(/why rent with homescount/i)).toBeVisible()
  ...
  test('sell page shows listing journey', async ({ page }) => {
    ...
    await acceptCookies(page)
    await expect(page.getByText(/why list on homescount/i)).toBeVisible()
  ...
  test('property detail shows journey guide', async ({ page }) => {
    ...
    await expect(page.getByText(/homescount will help you through every step/i)).toBeVisible()
  })
})
